  ...
  <body>
    <?php
     if ($_COOKIE['user']==''):
      ?>
      <?php else:?>
             <p>Привіт  <?php $_COOKIE['username'] ?>.Для того, щоб вийти натисніть тут: <a href="exit.php">Вихід</a> </p>
         <?php endif; ?>
    <header >
        <h1>
            BeCitizen
        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
              <div class="navbar-nav">
                ...
                <a class="nav-item nav-link active" id="regestrationlink" href="singin.php">Вхід/Реєстрація<span class="sr-only">(current)</span></a>
                <a class="nav-item nav-link active" id="searchlink" href="search.php">Пошук по тегах<span class="sr-only">(current)</span></a>
                <a class="nav-item nav-link active" id='chatslink' href="chats.php">Чати<span class="sr-only">(current)</span></a>
                <a class="nav-item nav-link active" id="ideaslink" href="ideas.php">Мої ідеї<span class="sr-only">(current)</span></a>
              </div>
            </div>
        </nav>
    </header>
